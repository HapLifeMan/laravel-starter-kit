    ...
    <div class="flex justify-center items-center h-screen" style="margin-top: -4rem;">
        <div class="w-full max-w-md md:mx-auto">
            <div class="rounded shadow">
                <div class="bonjour font-medium text-lg text-brand-darker bg-brand-lighter p-3 rounded-t">
                    Register
                </div>
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="flex">
                            <div class="w-3/4 ml-auto">
                                <button type="submit" class="bg-purple hover:bg-brand-dark text-white text-sm font-sembiold py-2 px-4 rounded mr-3">
                                    Register
                                </button>
                            </div>
                        </div>
